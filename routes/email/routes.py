...
auto-summarize + scheduled-email pollers, Pydantic models) lives in:
    ...
    routes/email/helpers.py   — synchronous helpers + models + constants
    routes/email/pollers.py   — background loops, started by `_start_poller`
...
from routes.email.helpers import (
...
from routes.email.pollers import _start_poller
